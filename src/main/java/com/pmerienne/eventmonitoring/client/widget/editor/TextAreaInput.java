...
public class TextAreaInput extends Composite implements HasValue<String> {

	private static TextAreaInputUiBinder uiBinder = GWT.create(TextAreaInputUiBinder.class);

	interface TextAreaInputUiBinder extends UiBinder<Widget, TextAreaInput> {
	}

	private final static String ERROR_CLASS = "error";
	private final static String SUCCESS_CLASS = "success";

	private final static String REQUIRED_ERROR = "Required";
